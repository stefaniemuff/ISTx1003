...
feilrate og nøyaktighet (accuracy)
...
Det kan nå gjøres med alle $k=1,3,\ldots$, $k\leq n$. De ser slik ut:
...
Det ser ut som at "Balance" er en ganske go forklarende variabel til Default (nei/ja).

```{r, echo=F,fig.width=8,fig.height=4,fig.align = "center",out.width='90%'}
library(ISLR)
data(Default)
