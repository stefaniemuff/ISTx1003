...
* Dette er resultatene fra modellene: 

```{r,eval=T, echo=F}
matrix(c(1923, 10, 52, 15),nrow=2,byrow=T)
matrix(c(1924, 9, 50, 17),nrow=2,byrow=T)
```
$~$


* Feilratene derfor er: 
    * Enkelt modell: 0.031
    * Multippel modell: 0.0295
