...
title: "Lineær regresjon (enkel og multippel)"
author: "Stefanie Muff, Institutt for matematiske fag"
date: "Oktober 20 og 21, 2025"
fontsize: 10pt
output:
  beamer_presentation:
    keep_tex: yes
...
* Vi ser på prosjektoppgaven på https://s.ntnu.no/isthub. Velg mappe **ProjectISTx1003**.
...
**\textcolor{red}{Fysisk veiledning for Trondheim:}**

**Alle fredager**: 24.10, 31.10., 7.11, og 14.11., 10:15-12:00, Sentralbygg S5.

\vspace{4mm} 

**\textcolor{red}{Digital veiledning for Ålesund og Gjøvik:}**
...
\centering
![](../../Prosjekt2025/Whereby_QR.png){width=16%}
   
    
---    
    
 
**\textcolor{red}{Mattelab forum for ALLE}**      
...
For en model for funker god for prediksjon trenger vi _multippel lineær regresjon_. Men vi begynner med _enkel lineær regresjon_ (bare en forklaringsvariabel):
...
* Relasjon mellom $Y$ og $x_1$ er antatt å være _lineær_. 
...
b) Kan vi tolke linja? Hvor sikkert er jeg på $\hat\beta_1$ og linja? Vi trenger antakelser, konfidensintervaller, og hypotesetest.
...
Nesten det samme some enkel lineær regresjon, vi bare summerer flere forklaringsvariabler:
...
Vi skal ikke snakke så mye om hvordan man finner en god modell, men om hvordan man sammenligner to
...
* Tilpasset regresjonslinje og 95% konfidensintervall for regressjonslinja (forventningsverdien $\text{E}(Y)$).
...
* 95% konfidensintervall: Intervall vi har stor tro at den inneholder den sanne stigningen $\beta_j$.
...
* Eksempel med 3 kategorier: Bildatasett med $y$=bensinforbruk og forklaringsvariabler `vekt` og `origin` som er en av de tre kategoriene \{\text{American,European,Japanese}\}. 
...
* Se her for mer informasjon: https://wiki.math.ntnu.no/istx100y/2025h/1003
